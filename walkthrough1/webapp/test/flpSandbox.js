		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Walkthrough Victor",
									"targetURL": "#WalkthroughVictor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"WalkthroughVictor-display": {
								"semanticObject": "WalkthroughVictor",
								"action": "display",
								"description": "Walkthrough Fiori App Dev",
								"title": "Walkthrough Victor",
								"signature": {
									"parameters": {}
								},
